        <!-- CARD ITEM  - vertical -->
        <?php echo '<a href="'.SCRIPT_ROOT.'/logements" class="card rad16 col-lg-3">'; ?>
          <?php echo '<img src="'.SCRIPT_ROOT.'/img/chalet.png">'; ?>
          <div class='card-main'>
            <div class='card-info'>
              <h3 class='h5 nmb'>Résidence Odalys Bellecôte</h3>
            ...
            <div class='card-info-2'>
              <p>16 déc.-24 jan.<br>1 à 6 personnes</p>
              <div class='card-price text-right'>
                <div class='price h4 bold'>1440€</div>
                <p class='size-tiny subbed'>soit 360€ /p.</p>
              </div>
            </div>
          </div>
        </a>